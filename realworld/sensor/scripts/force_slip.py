...
class ForcePredictorNode:
    def __init__(self):
        ...
        # ROS topics
        self.img_topic = rospy.get_param('~img_topic', f'{self.sensor_id}/marker')
        ...
        # 基线漂移消除相关设置
        self.calibration_time = rospy.get_param('~calibration_time', 30.0)  # 30秒校准时间
    ...
    def image_callback(self, msg):
        ...
        self.fy_pub.publish(float(force[1])*3)
        self.fx_pub.publish(float(force[0])*3)
