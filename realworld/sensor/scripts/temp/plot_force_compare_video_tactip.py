...
class ForceVisualizer(QMainWindow):
    ...
    def init_ui(self):
        ...
        self.sensor_combo.addItems(["AII", "uskin", "tactip"])
    ...
    def setup_force_charts(self, layout):
        ...
        series_ros_fx.setName("tactip Fx")
        ...
        series_ros_fy.setName("tactip Fy")
        ...
        series_ros_fz.setName("tactip Fz")
...
def main():
    ...
    parser.add_argument('--sensor', default='AII', help='ROS sensor type (AII or tactip)')
