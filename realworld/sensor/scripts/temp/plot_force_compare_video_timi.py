...
class ForceVisualizer(QMainWindow):
    ...
    def init_ui(self):
        ...
        self.sensor_combo.addItems(["timi_lines","timi_grid","timi_clear","timi_ink"])
    ...
    def setup_force_charts(self, layout):
        ...
        series_ros_fx.setName("GelSight Fx")
        ...
        series_ros_fy.setName("GelSight Fy")
        ...
        series_ros_fz.setName("GelSight Fz")
    ...
    def update_charts_from_cache(self, current_time):
        ...
        def to_points_ros(ts, xs):
            return [QPointF(t, x*2) for t, x in zip(ts, xs)]
