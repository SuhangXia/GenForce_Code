...
class ForcePredictorNode:
    def __init__(self):
        ...
        # ROS topics
        sensor = "AII"
        self.img_topic = rospy.get_param('~img_topic', f'/{sensor}/marker')
        self.fz_topic = rospy.get_param('~fz', f'/force/{sensor}/z')
        self.fy_topic = rospy.get_param('~fy', f'/force/{sensor}/y')
        self.fx_topic = rospy.get_param('~fx', f'/force/{sensor}/x')

        # Model/config paths (edit these if needed)
        # checkpoint_path = rospy.get_param('~checkpoint', '/home/zhuo/catkin_ws/src/genforce/checkpoints/force/force/homo/A-II/D-I_A-II.pth')
        # checkpoint_path = rospy.get_param('~checkpoint', '/home/zhuo/catkin_ws/src/genforce/checkpoints/force/force/homo/A-II/A-II.pth')
        checkpoint_path = rospy.get_param('~checkpoint_path', '/home/zhuo/catkin_ws/src/genforce/checkpoints/force/force/homo/A-II/D-I_A-II_seen.pth')
