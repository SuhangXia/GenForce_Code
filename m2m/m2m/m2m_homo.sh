python m2m/m2m/src/train_m2m.py --train_real \
    ...
    --dataset_folder=dataset/m2m/homo/img/npy \
    --resolution=256 --train_batch_size=1 --enable_xformers_memory_efficient_attention \
    --sensor_types Array-I Circle-I Diamond-I Array-II Circle-II --unseen sphere_s triangle pacman cone wave torus dots\
    ...
    --pretrained_ref_encoder=checkpoints/checkpoints/m2m/vae/model_70000.pth \
    --pretrained_model_name_or_path=checkpoints/checkpoints/m2m/homo/model_11501.pkl
