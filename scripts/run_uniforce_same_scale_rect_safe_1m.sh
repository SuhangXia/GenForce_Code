...
# 140 episodes / indenter gives 997,920 images under the fixed
# 18 indenters x 18 frames x 22 markers setup.
export OUTPUT_ROOT="${OUTPUT_ROOT:-/home/suhang/datasets/uniforce_same_scale_rect_safe_1m_short16_all18}"
export EPISODES_PER_INDENTER="${EPISODES_PER_INDENTER:-140}"
