...
def get_parser():
    ...
    parser.add_argument("--ori_root",type=str,default="src/modulus/temp/ori") #all images
    parser.add_argument("--marker_root",type=str,default="src/modulus/temp/out") #all images
    ...
    parser.add_argument("--img_dir",type=str,default="src/modulus/temp/ori") #single image
    parser.add_argument("--save_dir",type=str,default="src/modulus/temp/marker") #single image
...
def find_marker(frame,
        ...
        mask_range=(160, 255), min_value:int=70,
