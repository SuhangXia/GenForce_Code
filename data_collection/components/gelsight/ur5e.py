...
class FT_Sensor():
    def __init__(self,task,dir_ft,baseline_count=50):
        ...
        self.instance.createCalibration(CalFilePath='components/gelsight/config/FT31439.cal', index=1)
